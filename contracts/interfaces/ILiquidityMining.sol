...
interface ILiquidityMining {
    ...
    /// @return balances list of {LiquidityMiningTypes.DelegatedPwIporBalance} structure, with information how much Power Ipor Token is delegated per ipToken address.
    ...
    /// @notice Stakes ipToken amount into LiquidityMining.
    ...
    /// @notice Unstakes ipToken amount from LiquidityMining.
    ...
    /// @notice Unstakes ipToken amount from LiquidityMining and allocate rewards into storage.
    /// @param ipToken address for a specific underlying asset (ipUSDT, ipUSDC, ipDAI, etc.)
    /// @param ipTokenAmount ipToken amount being unstaked, represented in 18 decimals
