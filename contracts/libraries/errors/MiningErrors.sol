...
library MiningErrors {
    ...
    string public constant CALLER_NOT_LIQUIDITY_MINING = "IPOR_703";
    ...
    string public constant ACC_DELEGATED_TO_LIQUIDITY_MINING_BALANCE_IS_TOO_LOW = "IPOR_707";
    ...
    string public constant SENDER_NOT_APPOINTED_OWNER = "IPOR_719";
}
