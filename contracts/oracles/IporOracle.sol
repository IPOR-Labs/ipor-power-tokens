...
contract IporOracle is UUPSUpgradeable, IporOwnableUpgradeable, PausableUpgradeable, IIporOracle {
        ...
        )
    {
        ...
        require(ipor.quasiIbtPrice != 0, IporOracleErrors.IP_TOKEN_NOT_SUPPORTED);
        return (
    ...
    function removeIpToken(address asset) external override onlyOwner whenNotPaused {
        require(asset != address(0), IporErrors.WRONG_ADDRESS);
        require(_indexes[asset].quasiIbtPrice != 0, IporOracleErrors.IP_TOKEN_NOT_SUPPORTED);
