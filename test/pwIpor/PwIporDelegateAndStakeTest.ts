...
describe("PowerIpor delegateAndStakeToJohn", () => {
    ...
    it("Should be able to stake and delegate two asset and has the same values when one ipTokens is pass twice and the second once", async () => {
        ...
        expect(extractGlobalParam(globalParamsDaiBefore).aggregatedPowerUp).to.be.equal(
            extractGlobalParam(globalParamsUsdcBefore).aggregatedPowerUp
        );
        ...
        expect(
            extractGlobalParam(globalParamsDaiBefore).compositeMultiplierCumulativePrevBlock
        ).to.be.equal(
            extractGlobalParam(globalParamsUsdcBefore).compositeMultiplierCumulativePrevBlock
        );
        ...
        expect(extractGlobalParam(globalParamsDaiAfter).aggregatedPowerUp).to.be.equal(
            extractGlobalParam(globalParamsUsdcAfter).aggregatedPowerUp
        );
        ...
        expect(
            extractGlobalParam(globalParamsDaiAfter).compositeMultiplierCumulativePrevBlock
        ).to.be.equal(
            extractGlobalParam(globalParamsUsdcAfter).compositeMultiplierCumulativePrevBlock
        );
