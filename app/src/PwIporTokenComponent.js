            ...
            <div className="row">
                <table className="table" align="center">
                    ...
                    <tr style={{ padding: "1em" }}>
                        <td>
                            <strong>Delegate power ipor to LiquidityRewards</strong> <br />
                            Assets: <br />
                            <small>
                    ...
                    <tr>
                        <td>
                            <strong>Withdraw power ipor from LiquidityRewards</strong> <br />
                            Assets: <br />
                            <small>
